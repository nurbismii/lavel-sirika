...
{
    public function test_it_extracts_known_segment_codes_in_order()
    {
    ...
    public function test_it_marks_unknown_route_tokens_as_warning()
    {
    ...
    public function test_it_marks_long_instruction_text_as_warning()
    {
    ...
    public function test_it_marks_free_text_between_known_codes_as_warning()
    {
    ...
    public function test_it_removes_supplied_and_hierarchical_parking_codes_from_arrow_and_spaced_dash_routes()
    {
    ...
    public function test_it_keeps_hyphenated_free_text_for_review_when_it_is_not_a_parking_code()
    {
